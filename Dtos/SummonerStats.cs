...
namespace lol.stats.api.Dtos
{
    public class SummonerStats
    {
        ...
        public List<long> UniqueChampions { get; set; }

        public Dictionary<string, long> KillsByChampions { get; set; }
        public Dictionary<string, long> DeathsByChampions { get; set; }
        public Dictionary<string, long> AssistsByChampions { get; set; }
        public Dictionary<string, double> KdaByChampions { get; set; }
